# Tracer Nextflow Pipelines for Amazon Linux Aarch64(arm64)

This directory contains bioinformatics pipeline configurations optimized for Amazon Linux Aarch64 environments to test Tracer.
