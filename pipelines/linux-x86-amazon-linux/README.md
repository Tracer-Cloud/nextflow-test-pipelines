# Tracer Nextflow Pipelines for Amazon Linux x86_64

This directory contains bioinformatics pipeline configurations optimized for Amazon Linux x86_64 environments to test Tracer.
